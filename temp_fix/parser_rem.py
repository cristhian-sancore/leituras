...
def parse_rem(content: str) -> dict:
    ...
    for line in lines:
        ...
        if clean.startswith('A04'):
            ...
            # Mapeamento expandido: 01=agua, 02=esgoto, 04/05=lixo
            ...
            if cat and serv and v < 1000000:
                ...
                if len(tarifas_raw[cat][serv]) == 0:
                    # Água e Esgoto: valor no arquivo é unitário (v * n_faixa). 
                    # Lixo: valor no arquivo já é o fixo absoluto.
                    valor_fixo = round(v * n_faixa, 2) if serv in ('agua', 'esgoto') else round(v, 2)
