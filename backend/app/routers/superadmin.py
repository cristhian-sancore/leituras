...
async def list_todas_empresas(
    ...
    for empresa, total_u, total_l in rows.all():
        items.append(EmpresaDetalhada(
            ...
            layout_notificacao_id=empresa.layout_notificacao_id,
...
async def criar_layout(
    ...
    novo = LayoutImpressao(
        nome=data.nome, 
        conteudo_cpcl=data.conteudo_cpcl, 
        estado_fabric=data.estado_fabric,
...
async def editar_layout(
    ...
    layout.estado_fabric = data.estado_fabric
