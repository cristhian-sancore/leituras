...
def calcular_conta(
    ...
    Args:
        consumo: consumo em m³
        tarifas_agua: faixas de tarifa de água
        tarifas_lixo: faixas de tarifa de lixo
        percentual_esgoto: % do valor de água cobrado como esgoto (configurável por empresa)
        consumo_minimo: m³ incluídos na taxa mínima
    ...
    valor_esgoto = round(valor_agua * (percentual_esgoto / 100), 2)
    valor_lixo = calcular_por_faixas(consumo, tarifas_lixo, consumo_minimo)
