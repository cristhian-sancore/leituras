...
const ZebraPrint = (() => {
  ...
  function layoutGenerico(dados) {
    return [
      ...
      'T 7 0 80 97 DATA DE INSTALACAO',
      ...
      'T 7 0 20 118 {HIST_CONS_1}',
      'T 7 0 31 118 {HIST_DIAS_1}',
      'T 7 0 38 118 {HIST_MEDIA_1}',
      'T 7 0 4 121 {HIST_MES_2}',
      'T 7 0 20 121 {HIST_CONS_2}',
      'T 7 0 31 121 {HIST_DIAS_2}',
      'T 7 0 38 121 {HIST_MEDIA_2}',
      'T 7 0 4 124 {HIST_MES_3}',
      'T 7 0 20 124 {HIST_CONS_3}',
      'T 7 0 31 124 {HIST_DIAS_3}',
      'T 7 0 38 124 {HIST_MEDIA_3}',
      'T 7 0 4 127 {HIST_MES_4}',
      'T 7 0 20 127 {HIST_CONS_4}',
      'T 7 0 31 127 {HIST_DIAS_4}',
      'T 7 0 38 127 {HIST_MEDIA_4}',
      'T 7 0 4 130 {HIST_MES_5}',
      'T 7 0 20 130 {HIST_CONS_5}',
      'T 7 0 31 130 {HIST_DIAS_5}',
      'T 7 0 38 130 {HIST_MEDIA_5}',
      'T 7 0 4 133 {HIST_MES_6}',
      'T 7 0 20 133 {HIST_CONS_6}',
