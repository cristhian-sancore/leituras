...
const ZebraPrint = (() => {
  ...
  function layoutGenerico(dados) {
    ...
    return [
      ...
      'T 0 2 3 28 FAIXA DE CONSUMO    R$ AGUA',
      'T 0 2 52 28 TARIFAS E SERVICOS  R$ VALOR',
      ...
      'T 0 2 3 156 PERIODO DA ANALISE: 24/08/2021 a',
      'LINE 2 160 100 160 0.2',
      'T 0 2 3 161 PARAMETRO         VMP         VALOR MEDIO DETECTADO',
      'T 0 2 5 164 CLORO        0,2 e 2,0           1,3',
      'T 0 2 5 167 COR             15               6,1',
      'T 0 2 5 170 FLUOR          1,5               1,5',
      'T 0 2 5 173 PH           6,0 e 9,5           7,89',

      'LINE 2 177 100 177 0.2',
      'LINE 2 181 100 181 0.2',
      'T 0 2 3 178 FAVOR AUTENTICAR NO VERSO - DEVOLVER AO USUARIO',
      'T 0 2 55 178 EMISSAO: {DATA_EMISSAO} {HORA_EMISSAO}',
